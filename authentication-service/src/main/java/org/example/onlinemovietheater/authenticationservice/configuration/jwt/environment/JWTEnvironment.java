package org.example.onlinemovietheater.authenticationservice.configuration.jwt.environment;
...
public class JWTEnvironment {
    ...
    public JWTEnvironment(@Value("${jwt.token}") String JWT_SECRET_TOKEN, @Value("${jwt.lifetime}") int JWT_LIFETIME) {
